...
async def cmd_start(message: Message):
    # Создаем удобные кнопки с готовыми идеями для теста
    kb = [
    ...
    keyboard = ReplyKeyboardMarkup(
        ...
        input_field_placeholder="Напишите свою идею или выберите шаблон..."
    )
    
    welcome_text = (
        "📊 <b>Привет! Я твой персональный ИИ-бизнес-консультант.</b>\n\n"
        "Я помогаю анализировать стартапы с точки зрения экономики, юнит-анализа и рисков.\n\n"
        "💡 <i>Просто напиши мне свою задумку или нажми на один из готовых шаблонов внизу!</i>"
    )
    await message.answer(welcome_text, parse_mode="HTML", reply_markup=keyboard)

# ==========================================
# АНАЛИЗ БИЗНЕС-ИДЕИ ЧЕРЕЗ GEMINI
# ==========================================
@dp.message(F.text)
